...
AS
SELECT P.NOME AS 'NOME DA PESSOA', PN.N_IDENTIFICADOR AS 'NÚMERO IDENTIFICADOR DA PESSOA', EM.NOME AS 'NOME DA EMPRESA', 
CL.DESCRICAO AS 'CLASSIFICAÇÃO', DATA AS 'DATA DO ACESSO', HORA_SEGUNDOS(HORA) AS 'HORA DO ACESSO'
